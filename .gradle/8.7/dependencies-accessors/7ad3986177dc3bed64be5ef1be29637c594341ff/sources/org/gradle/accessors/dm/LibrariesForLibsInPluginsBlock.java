...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>locs</b> with <b>com.google.android.gms:play-services-location</b> coordinates and
         * with version reference <b>googleLocs</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getLocs() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("google.locs");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>googleLocs</b> with value <b>21.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleLocs() { return getVersion("googleLocs"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final MapPluginAccessors paccForMapPluginAccessors = new MapPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.map</b>
         */
        public MapPluginAccessors getMap() {
            return paccForMapPluginAccessors;
        }
    ...
    public static class MapPluginAccessors extends PluginFactory {

        public MapPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>map.secret</b> with plugin id <b>com.google.android.libraries.mapsplatform.secrets-gradle-plugin</b> and
         * with version reference <b>mapsSecret</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getSecret() { return createPlugin("map.secret"); }
